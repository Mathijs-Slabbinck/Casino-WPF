...
{
    public class EightOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Eight of Diamonds";
        private readonly string rank = "8";
        private readonly int rankValue = 8;
        ...
        public EightOfDiamonds(int lvalue = 8)
        {
            value = lvalue;
