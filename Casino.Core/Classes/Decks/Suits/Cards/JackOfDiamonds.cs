...
{
    public class JackOfDiamonds : Spades, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Jack of Diamonds";
        private readonly string rank = "Jack";
        private readonly int rankValue = 11;
        ...
        public JackOfDiamonds(int lvalue = 11)
        {
            value = lvalue;
