...
{
    public class QueenOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Queen of Diamonds";
        private readonly string rank = "Queen";
        private readonly int rankValue = 12;
        ...
        public QueenOfDiamonds(int lvalue = 12)
        {
            value = lvalue;
