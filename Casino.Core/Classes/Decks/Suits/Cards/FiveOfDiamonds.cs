...
{
    public class FiveOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Five of Diamonds";
        private readonly string rank = "5";
        private readonly int rankValue = 5;
        ...
        public FiveOfDiamonds(int lvalue = 5)
        {
            value = lvalue = 5;
