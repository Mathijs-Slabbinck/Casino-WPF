...
{
    public class AceOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Ace of Diamonds";
        private readonly string rank = "Ace";
        private readonly int rankValue = 1;
        ...
        public AceOfDiamonds(int lvalue = 1)
        {
            value = lvalue;
