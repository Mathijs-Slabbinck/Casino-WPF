...
{
    public class TenOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Ten of Diamonds";
        private readonly string rank = "10";
        private readonly int rankValue = 10;
        ...
        public TenOfDiamonds(int lvalue = 10)
        {
            value = lvalue;
