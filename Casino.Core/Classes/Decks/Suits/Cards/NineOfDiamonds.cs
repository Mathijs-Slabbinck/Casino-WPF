...
{
    public class NineOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Nine of Diamonds";
        private readonly string rank = "9";
        private readonly int rankValue = 9;
        ...
        public NineOfDiamonds(int lvalue = 9)
        {
            value = lvalue;
