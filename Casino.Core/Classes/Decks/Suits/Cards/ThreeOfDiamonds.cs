...
{
    public class ThreeOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Three of Diamonds";
        private readonly string rank = "3";
        private readonly int rankValue = 3;
        ...
        public ThreeOfDiamonds(int lvalue = 3)
        {
            value = lvalue;
