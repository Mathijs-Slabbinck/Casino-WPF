...
{
    public class FourOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Four of Diamonds";
        private readonly string rank = "4";
        private readonly int rankValue = 4;
        ...
        public FourOfDiamonds(int lvalue = 4)
        {
            value = lvalue;
