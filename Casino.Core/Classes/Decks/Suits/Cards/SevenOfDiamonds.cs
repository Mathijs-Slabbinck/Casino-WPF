...
{
    public class SevenOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Seven of Diamonds";
        private readonly string rank = "7";
        private readonly int rankValue = 7;
        ...
        public SevenOfDiamonds(int lvalue = 7)
        {
            value = lvalue;
