...
{
    public class KingOfDiamonds : Diamonds, ICard
    {
        private readonly int value;
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "King of Diamonds";
        private readonly string rank = "King";
        private readonly int rankValue = 13;
        ...
        public KingOfDiamonds(int lvalue = 13)
        {
            value = lvalue;
