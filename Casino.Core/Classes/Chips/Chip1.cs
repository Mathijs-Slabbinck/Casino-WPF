...
namespace Casino.Core.Classes.Chips
{
    public class Chip1 : IChip
    {
        ...
        public Chip1()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip1.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip1.png", UriKind.RelativeOrAbsolute));
        }
    }
}
