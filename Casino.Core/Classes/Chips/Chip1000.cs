...
{
    public class Chip1000 : IChip
    {
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Chip1000";
        private readonly int value = 1000;
        private int amount;
        ...
        public Chip1000()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip1000.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip1000.png", UriKind.RelativeOrAbsolute));
        }
    }
}
