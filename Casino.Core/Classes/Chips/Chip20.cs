...
{
    public class Chip20 : IChip
    {
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Chip20";
        private readonly int value = 20;
        private int amount;
        ...
        public Chip20()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip20.png", UriKind.RelativeOrAbsolute));
