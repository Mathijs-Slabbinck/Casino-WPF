...
namespace Casino.Core.Classes.Chips
{
    public class Chip10 : IChip
    {
        ...
        public Chip10()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip10.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip10.png", UriKind.RelativeOrAbsolute));
        }
    }
}
