...
{
    public class Chip500 : IChip
    {
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Chip500";
        private readonly int value = 500;
        private int amount;
        ...
        public Chip500()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip500.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip20.png", UriKind.RelativeOrAbsolute));
        }
    }
}
