...
{
    public class Chip5000 : IChip
    {
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Chip5000";
        private readonly int value = 5000;
        private int amount;
        ...
        public Chip5000()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip5000.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip5000.png", UriKind.RelativeOrAbsolute));
        }
    }
}
