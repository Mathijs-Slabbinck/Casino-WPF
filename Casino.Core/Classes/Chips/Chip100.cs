...
{
    public class Chip100 : IChip
    {
        private readonly BitmapImage image;
        private readonly BitmapImage bottomImage;
        private readonly string name = "Chip100";
        private readonly int value = 100;
        private int amount;
        ...
        public Chip100()
        {
            ...
            image = new BitmapImage(new Uri(@"Assets/chips/notOnTable/Chip100.png", UriKind.RelativeOrAbsolute));
            bottomImage = new BitmapImage(new Uri(@"Assets/onTable/chips/Chip100.png", UriKind.RelativeOrAbsolute));
        }
    }
}
